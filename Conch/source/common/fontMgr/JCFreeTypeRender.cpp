...
namespace laya
{
    unsigned short * JCFreeTypeFontRender::m_pWordBmpBorder = nullptr;
...
#endif
        m_pWordBmpBorder = new unsigned short[MAX_CHAR_WIDTH * MAX_CHAR_HEIGHT * 4];
    ...
    JCFreeTypeFontRender::~JCFreeTypeFontRender()
    {
        ...
        if (m_pWordBmpBorder) {
            delete [] m_pWordBmpBorder;
            m_pWordBmpBorder = nullptr;
        }
        JCFreeTypeFontRender::m_pWordBmpBorder = nullptr;
    }
