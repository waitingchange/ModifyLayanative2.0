...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NativeViewController* pViewController  = [[NativeViewController alloc] init];
...
{
    NSLog(@"fuck js call Native !!!!!!!!!");
    return @"hshshshshshshs ,,, callback ";
}
...
-(void)changeRootVC
{
    ...
    if ([vc isKindOfClass:[ViewController class]]) {
        ...
        _window.rootViewController = [[NativeViewController alloc]init];
        [_window makeKeyAndVisible];
